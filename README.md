...
- **[paas.build](https://github.com/UNIPaaS/paas-build-mcp)** - Your agent takes a business live on payments: `go_live` opens a real merchant account (sandbox + production, FCA-authorised rails), `create_checkout` returns a payable link. Payments for AI builders at 3.9% flat, powered by [UniPaaS](https://paas.build).
